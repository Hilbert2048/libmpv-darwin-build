{
  ...
  mpv = {
    version = "0.65.0-preload-fix";
    url = "https://github.com/Hilbert2048/mpv/archive/cfd1bd488735397ffbc76d6c0d5c78f5af3397ac.tar.gz";
    sha256 = "sha256:02c5m8hsd1mxfhzca221ypqz10bz6rwjg03mwd7vn213snrbsjp5";
  };
  libplacebo = {
    version = "7.349.0";
