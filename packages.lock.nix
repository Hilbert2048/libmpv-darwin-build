{
  ...
  mpv = {
    version = "0.64.0-preload-fix";
    url = "https://github.com/Hilbert2048/mpv/archive/65deeaa68f3c80c32191f4bd588c14cd27e13787.tar.gz";
    sha256 = "sha256:0yi49hmczy3bcszg6p9icqkz5xd02774gqb3a4xijxxd90h32fi8";
  };
  libplacebo = {
    version = "7.349.0";
